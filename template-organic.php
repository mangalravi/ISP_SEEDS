<?php 
/* Template Name: Organic Bio Fertilizer */
...
< <div class="pt70">
    ...
    <div class="container">
          ...
          <div class="prod-carddiv">
                <h4>Organic Fertilizer (PGR)</h4>
                <div class="row g-4">
                
                <?php
// Define your custom taxonomy and subcategory slug
$taxonomy = 'product-cat'; // Replace with your custom taxonomy
$subcategory_slug = 'organic-fertilizer-pgr'; // Replace with your subcategory slug
...
// Define your custom taxonomy and subcategory slug
$taxonomy = 'product-cat'; // Replace with your custom taxonomy
$subcategory_slug = 'bio-pesticide-neemastra'; // Replace with your subcategory slug
