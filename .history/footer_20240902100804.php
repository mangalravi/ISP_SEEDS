...
<footer>
      ...
      <div class="bdrbtm">
        <div class="row justify-content-between">
          ...
          <h3>Reach out to the fastest growing organisation in the agricultural market.</h3>
          </div>
          <div class="col-lg-6">
            <div class="btngrp">
      ...
      <div class="bdrbtm">
        <div class="row g-3">
          <div class="col-md-4">
            <div class="leftftr">
              <h5 class="text-center text-md-start">Inventive Seeds Pvt. Ltd.</h5>
              <div class="btmftr">
                <div class="mnbtm">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-4">
               ...
               <ul class="socialimg justify-content-center justify-content-md-between">
                ...
                <!--<img src="<?php //echo get_template_directory_uri(); ?>/content/images/ISP-QR.png" alt="QR" class="mr22" /> -->
      ...
      <div class="d-flex justify-content-between align-items-start align-items-sm-center flex-column flex-sm-row g2">
        <div class="leftbtm">
        ...
        <div class="rightbtm">
          <ul>
            ...
            <!-- <li><a href="https://hr.ispseeds.com/" target="_blank">Login</a></li> -->
          </ul>
        </div>
      </div>
      </div>
